...
export type Property = {
  ...
  price?: string;
  sold: boolean;
  category?: "Apartment" | "House" | "Condo" | "Land" | "TownHouse" | "PentHouse" | "Ranch";
  status?: "For Sale" | "For Rent";
  description?: string;
  photos?: Photo[] | string[]; // accept either normalized objects or strings
  bedrooms?: number | string;
  bathrooms?: number | string;
  size?: string;
  // add any other fields you use in your markdown frontmatter
};

export default function PropertyGrid({ initialProperties = [] }: { initialProperties: Property[] }) {
    ...
    <section id="properties" className="py-12 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {items.slice(0, visibleCount).map((property) => {
